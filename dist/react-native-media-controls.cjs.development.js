...
var Slider = function Slider(props) {
  ...
  var isFullScreen = Boolean(onFullScreen);
  return React__default.createElement(reactNative.View, {
  ...
  })), isFullScreen && React__default.createElement(reactNative.TouchableOpacity, {
    style: styles.fullScreenContainer,
    onPress: onFullScreen,
    accessible: true,
    accessibilityLabel: isFullScreen ? 'Tap to Exit Fullscreen' : 'Tap to Enter Fullscreen',
